...
class Ui_DialogSettings(object):
    def setupUi(self, DialogSettings):
        ...
        self.formLayout_2.setWidget(0, QFormLayout.ItemRole.FieldRole, self.dspbox_alpha)
        ...
        self.formLayout_2.setWidget(1, QFormLayout.ItemRole.FieldRole, self.btn_select_color)
        ...
        self.gridLayout_7.addWidget(self.cmbox_loglevel, 1, 1, 1, 1)
    ...
    def retranslateUi(self, DialogSettings):
        ...
        self.groupBox_3.setTitle(QCoreApplication.translate("DialogSettings", u"Others", None))
