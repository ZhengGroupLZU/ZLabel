...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/icon/icons/isat_bg_50x25.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.actionImport.setIcon(icon24)
        ...
        self.menubar.setGeometry(QRect(0, 0, 879, 24))
        ...
        icon32 = QIcon()
        icon32.addFile(u":/icon/icons/translate.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.menuLaguage.setIcon(icon32)
        ...
        sizePolicy1.setHeightForWidth(self.dock_files.sizePolicy().hasHeightForWidth())
        self.dock_files.setSizePolicy(sizePolicy1)
        ...
        MainWindow.addDockWidget(Qt.RightDockWidgetArea, self.dock_files)
        ...
        self.menuTools.addAction(self.actionModel_manage)
...
#if QT_CONFIG(tooltip)
        self.actionSave.setToolTip(QCoreApplication.translate("MainWindow", u"Save Project", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
...
#if QT_CONFIG(tooltip)
        self.actionSAM.setToolTip(QCoreApplication.translate("MainWindow", u"SAM", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.actionSAM.setStatusTip(QCoreApplication.translate("MainWindow", u"Quick annotate using Segment anything.", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(shortcut)
...
#if QT_CONFIG(tooltip)
        self.actionCancel.setToolTip(QCoreApplication.translate("MainWindow", u"Clear All", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.actionCancel.setStatusTip(QCoreApplication.translate("MainWindow", u"Clear All", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(shortcut)
...
#if QT_CONFIG(tooltip)
        self.actionFinish.setToolTip(QCoreApplication.translate("MainWindow", u"Annotate finished", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
...
#if QT_CONFIG(tooltip)
        self.actionImport.setToolTip(QCoreApplication.translate("MainWindow", u"Convert COCO to ISAT", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.actionImport.setStatusTip(QCoreApplication.translate("MainWindow", u"Convert COCO json to ISAT jsons.", None))
#endif // QT_CONFIG(statustip)
...
#if QT_CONFIG(statustip)
        self.actionOpenCV.setStatusTip(QCoreApplication.translate("MainWindow", u"Enable OpenCV", None))
#endif // QT_CONFIG(statustip)
