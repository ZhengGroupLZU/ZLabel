...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon9 = QIcon()
        icon9.addFile(u":/icon/icons/back.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon32 = QIcon()
        icon32.addFile(u":/icon/icons/channel_r.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon33 = QIcon()
        icon33.addFile(u":/icon/icons/channel_g.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon34 = QIcon()
        icon34.addFile(u":/icon/icons/channel_b.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon35 = QIcon()
        icon35.addFile(u":/icon/icons/channel.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon36 = QIcon()
        icon36.addFile(u":/icon/icons/channel_gray.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon37 = QIcon()
        icon37.addFile(u":/icon/icons/merge.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon38 = QIcon()
        icon38.addFile(u":/icon/icons/translate.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.menuLang.setIcon(icon38)
