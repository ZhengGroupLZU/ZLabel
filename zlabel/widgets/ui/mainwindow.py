...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon44 = QIcon()
        icon44.addFile(u":/icon/icons/dock_left.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionFiles.setIcon(icon44)
        self.actionInfo = QAction(MainWindow)
        self.actionInfo.setObjectName(u"actionInfo")
        self.actionInfo.setCheckable(True)
        self.actionInfo.setChecked(True)
        icon45 = QIcon()
        icon45.addFile(u":/icon/icons/dock_right.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionInfo.setIcon(icon45)
        ...
        self.actionAnnotations.setIcon(icon45)
        ...
        self.actionLabels.setIcon(icon45)
        self.actionRestore = QAction(MainWindow)
        self.actionRestore.setObjectName(u"actionRestore")
        icon46 = QIcon()
        icon46.addFile(u":/icon/icons/reset.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionRestore.setIcon(icon46)
        self.actionFullScreen = QAction(MainWindow)
        self.actionFullScreen.setObjectName(u"actionFullScreen")
        self.actionFullScreen.setCheckable(True)
        icon47 = QIcon()
        icon47.addFile(u":/icon/icons/fullscreen.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionFullScreen.setIcon(icon47)
        ...
        icon48 = QIcon()
        icon48.addFile(u":/icon/icons/translate.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.menuLang.setIcon(icon48)
        ...
        self.menuAnno_Type.setEnabled(False)
        ...
        self.menuAnno_Type.addAction(self.actionAnnoTypeRLEMask)
