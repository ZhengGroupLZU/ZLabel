...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon40 = QIcon()
        icon40.addFile(u":/icon/icons/dock_left.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionFiles.setIcon(icon40)
        self.actionInfo = QAction(MainWindow)
        self.actionInfo.setObjectName(u"actionInfo")
        self.actionInfo.setCheckable(True)
        self.actionInfo.setChecked(True)
        icon41 = QIcon()
        icon41.addFile(u":/icon/icons/dock_right.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionInfo.setIcon(icon41)
        ...
        self.actionAnnotations.setIcon(icon41)
        ...
        self.actionLabels.setIcon(icon41)
        self.actionRestore = QAction(MainWindow)
        self.actionRestore.setObjectName(u"actionRestore")
        icon42 = QIcon()
        icon42.addFile(u":/icon/icons/reset.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionRestore.setIcon(icon42)
        ...
        icon43 = QIcon()
        icon43.addFile(u":/icon/icons/translate.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.menuLang.setIcon(icon43)
        ...
        icon44 = QIcon()
        icon44.addFile(u":/icon/icons/dock_bottom.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.menuDocks.setIcon(icon44)
